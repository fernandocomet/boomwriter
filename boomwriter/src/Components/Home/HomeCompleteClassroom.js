            ...
            <div className="container text-center">
                ...
                <div className="row text-white mb-5 d-flex flex-column flex-sm-row">
                    <div className="col bg-danger">
                        ...
                        <h2>Writing</h2>
                        <p>Get the best from your writers in <span className="fontWeight-bold">any subject</span></p>
                    ...
                    <div className="col bg-success">
                        ...
                        <h2>Voting</h2>
                        <p>Embrace <span className="fontWeight-bold">Peer Appraisal</span> in your classroom</p>
                        <i className="fas fa-play-circle fa-3x"></i>
                        <p>Play Video</p>
                    </div>
                    <div className="col bg-info">
                        ...
                        <h2>Reading</h2>
                        <p>Writing is only half of the literacy challenge. Using our writing app will also <span className="fontWeight-bold">enhance reading skills</span></p>
                        <i className="fas fa-play-circle fa-3x"></i>
                        <p>Play Video</p>
                    </div>
                    <div className="col bg-warning">
                        ...
                        <h2>Grading</h2>
                        <p><span className="fontWeight-bold">Easy to use</span> Gradebook featuring standards-based rubrics</p>
                    </div>
                </div>
                <button type="button" className="btn btn-lg btn-outline-primary mb-5">Sign up for free as a teacher</button>
            </div>
        )
    }
